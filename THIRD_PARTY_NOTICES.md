...
| Apache ECharts                                                  | Apache-2.0       | [apache/echarts](https://github.com/apache/echarts), [bundled notice](apps/console/public/licenses/ECHARTS_NOTICE.txt)                                                                                                 |
...
IBM Plex font files are redistributed under the [SIL Open Font License 1.1](https://openfontlicense.org/open-font-license-official-text/). Apache ECharts and Paper Shaders are redistributed under the [Apache License 2.0](https://www.apache.org/licenses/LICENSE-2.0). The Ridge Weekender image is a local, optimized derivative of the linked Unsplash source and is covered by the Unsplash License.
