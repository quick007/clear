...
IBM Plex font files are redistributed under the [SIL Open Font License 1.1](https://openfontlicense.org/open-font-license-official-text/). Apache ECharts is redistributed under the [Apache License 2.0](https://www.apache.org/licenses/LICENSE-2.0). The Ridge Weekender image is a local, optimized derivative of the linked Unsplash source and is covered by the Unsplash License.
