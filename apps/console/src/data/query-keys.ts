...
export const queryKeys = {
  ...
  logs: (projectId: ProjectId, search: string, window: string, service?: string) =>
    ["groundtruth", String(projectId), "logs", search, window, service] as const,
  traces: (projectId: ProjectId, search: string, window: string, service?: string) =>
    ["groundtruth", String(projectId), "traces", search, window, service] as const,
  ...
  deploys: (projectId: ProjectId) => ["groundtruth", String(projectId), "deploys"] as const,
